# Lesson 39 — Punctuation is evidence · sentences

Drafted 28 August 2026. See [README.md](README.md).

**This is the most uniform lesson in the course, and it is second from the end.**
One distinct asked-shape and identical picks — 41 — for all ten built sentences.
Every one is two clauses, eleven words, a comma before the coordinator.

**The comma before a coordinator is the least informative comma in English.** It
marks a boundary the coordinator has already marked; removing it changes nothing
structural. Meanwhile the course has built four constructions where punctuation
carries real weight and none is here.
...
29, a supplement from lesson 38. None needs new grammar.

Item 9 is the serial comma, the one mark in the lesson a reader could argue
about, and it comes from lesson 26's three-way list.

Items 1 and 8 keep the controlled pair with lesson 33, which has these shapes
without commas. That pairing is the one thing the built lesson does right.
