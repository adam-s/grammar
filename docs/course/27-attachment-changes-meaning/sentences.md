# Lesson 27 — Attachment changes meaning · sentences
...
| 9   | The inspector photographed the house from the road. | the phrase is further from both anchors           |
...
consequence: if _the boy with the binoculars_ replaces with _him_, the phrase
attached to the noun. If only _the boy_ does, it attached to the verb.
