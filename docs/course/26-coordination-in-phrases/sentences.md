# Lesson 26 — Coordination inside phrases · sentences
...
| 2   | We packed the books and the maps.                 | **the same join, in an object**              |
...
| 10  | The jury and the judge questioned the evidence.   | close on the plain case                      |
...
being one — and that is a question, not a sentence.
