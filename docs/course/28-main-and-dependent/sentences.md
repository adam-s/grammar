# Lesson 28 — Main and dependent clauses · sentences
...
scope working correctly. The consequence is that this lesson shows only the
object clause without a marker, and lesson 30 shows only the subject clause with
one — two variables moving together. Lesson 30 is where that is fixed.
