# Lesson 4 — Noun phrases · sentences
...
for lesson 4 is the one thing it can honestly ask: **how much can the subject
slot hold?** So the size of the subject is what varies, from one word to six, and
the substitution test is what settles every one.

## Sentences

| #   | Sentence                           | The step                                       |
| --- | ---------------------------------- | ---------------------------------------------- |
| 1   | She waited.                        | the whole subject is one word                  |
| 2   | The engine stalled.                | two words, same slot                           |
| 3   | My quiet neighbour waved.          | three words, same slot                         |
| 4   | The old engine stalled again.      | the predicate grows while the subject holds    |
