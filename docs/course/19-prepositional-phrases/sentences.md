...
| 8   | We walked along the path beside the river.     | two phrases, and where the second attaches       |
| 9   | She read her report on the train.              | the same shape, and now the reading is not fixed |
| 10  | Our guide led us through the tunnel.           | back to a plain adverbial                        |
