# Lesson 19 — Prepositional phrases · sentences
...
| 5   | The key to the door vanished.                  | a phrase **inside a noun phrase**                   |
| 6   | The lid of the box of tools cracked.           | **nested twice, with only one reading**             |
| 7   | The mist lifted before the dawn.               | a preposition of time, not place                    |
| 8   | We walked along the path beside the river.     | two phrases, and the second could attach either way |
| 9   | She read her report on the train.              | a phrase whose attachment is genuinely open         |
| 10  | Our guide led us through the tunnel.           | a plain adverbial phrase after an object            |
