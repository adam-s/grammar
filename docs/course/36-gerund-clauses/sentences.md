# Lesson 36 — Gerund clauses · sentences
...
| 3   | Reading old maps requires practice.       | a premodifier inside the gerund's object      |
| 4   | She enjoys reading old maps.              | **the same clause, now an object**            |
