...
function ask(session: Session, sentence: SentenceEntry, words: Word[], o: LabelOption): Ask | null {
  ...
  if (o.gap && o.func && node && selection.kind === 'node') {
    ...
    return {
      key: `gap:${targetKey(build, selection)}:${o.func}`,
  ...
  if (o.form) {
    ...
    return {
      ...
      key: `form:${o.level ?? 'any'}:${targetKey(build, selection)}`,
  ...
  if (o.anchor && node && selection.kind === 'node') {
    ...
    return {
      key: `anchor:${targetKey(build, selection)}`,
  ...
  if (o.fusedWith && node && selection.kind === 'node') {
    const id = selection.id;
    return {
      key: `fuse:${targetKey(build, selection)}`,
  ...
  if (o.func && node && selection.kind === 'node') {
    const id = selection.id;
    return {
      key: `func:${targetKey(build, selection)}`,
  ...
  if (o.voice && at !== undefined && selection.kind === 'node') {
    const id = selection.id;
    return {
      key: `voice:${targetKey(build, selection)}`,
  ...
  if (o.auxKind && at !== undefined && selection.kind === 'node') {
    const id = selection.id;
    return {
      key: `aux:${targetKey(build, selection)}`,
  ...
  if (o.partKind && at !== undefined && selection.kind === 'node') {
    const id = selection.id;
    return {
      key: `part:${targetKey(build, selection)}`,
  ...
  if (o.clauseKind && node && selection.kind === 'node') {
    const id = selection.id;
    return {
      key: `kind:${targetKey(build, selection)}`,
  ...
  if (o.finiteness && node && selection.kind === 'node') {
    const id = selection.id;
    return {
      key: `fin:${targetKey(build, selection)}`,
  ...
  if (o.verbType && at !== undefined && selection.kind === 'node') {
    const id = selection.id;
    return {
      key: `vt:${targetKey(build, selection)}`,
...
export function answer(
  ...
  if (wrong) {
    const where = targetKey(session.build, session.selection);
